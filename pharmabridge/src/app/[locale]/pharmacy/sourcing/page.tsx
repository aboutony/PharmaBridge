          ...
          <div className="grid gap-4 tablet:grid-cols-2">
            {offers.map((offer) => (
              <GlassPanel key={offer.supplier} level={1} interactive className="p-6">
                <p className="text-xl font-semibold text-white">{offer.supplier}</p>
                <p className="mt-3 text-sm text-white/65">{offer.meta}</p>
                <div className="mt-5 flex gap-3">
                  ...
                  <Link href={`/${currentLocale}/pharmacy/analytics`} className="rounded-2xl border border-white/12 bg-white/8 px-4 py-3 text-sm font-semibold text-white">
